...
@TeleOp(name="TeleOp6407Skystone", group="Iterative Opmode")
//@Disabled
public class TeleOp6407Skystone extends OpMode {
    // Declare OpMode members.
    private ElapsedTime runtime = new ElapsedTime();
    Hardware6407Skystone robot = new Hardware6407Skystone();   // Use a 7615's hardware
